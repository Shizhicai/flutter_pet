...
class JsonConvert {
  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _fromJsonSingle<M>(Map<String, dynamic> json) {
		...
		if(type == (PetTypeEntity).toString()){
			return PetTypeEntity.fromJson(json) as M;
		}
  ...
  //list is returned by type
	static M? _getListChildType<M>(List data) {
		...
		if(<PetTypeEntity>[] is M){
			return data.map<PetTypeEntity>((e) => PetTypeEntity.fromJson(e)).toList() as M;
		}
